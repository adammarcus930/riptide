...
public enum MuscleGroup: String, Codable, CaseIterable, Identifiable, Sendable {
    case chest, lats, frontDelts, sideDelts, rearDelts, traps, quads, hamstrings, calves
    ...
    public static let givers: [MuscleGroup] = [.chest, .lats, .frontDelts, .sideDelts, .rearDelts, .traps, .quads, .hamstrings, .calves]
    ...
    public static let displayOrder: [MuscleGroup] = [.quads, .hamstrings, .chest, .lats, .frontDelts, .sideDelts, .rearDelts, .traps, .triceps, .biceps, .forearms, .calves, .abs]
}
